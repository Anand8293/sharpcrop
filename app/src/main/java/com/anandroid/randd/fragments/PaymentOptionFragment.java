 ...
 * Use the {@link PaymentOptionFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PaymentOptionFragment extends BaseFragmentActivity implements View.OnClickListener {

    TextView amt,notes;
    RadioGroup payment;
    TextView promoCodeClick;
    Button submit,apply;
    String promo="";
    Dialog dialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        amt = (TextView)v.findViewById(R.id.total_amount);
...
//               Toast.makeText(getActivity(),""+rb.getText(),Toast.LENGTH_LONG).show();
        ...
        setTextViewText(R.id.title_text,"Payment Option");
        ((TextView)v.findViewById(R.id.total_amount)).setText(String.valueOf(UserPrefs.totalAmount));
        getPromoList();
        return v;
    }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            apply.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(dialog.isShowing())
                        dialog.dismiss();
                    promoCodeClick.setVisibility(View.GONE);
...
//        testing purpose
        ...
        Log.e(Constants.TAG," Hash Key => "+serverCalculatedHash);
        paymentParam.setMerchantHash("OIP35NjBSVtyeVBL29u9r4Ua2ks3986Bk8D6mWGUzDQ=");
